...
- Viewport: 1440 × 900
- State: fresh browser storage in the July 19 release, **The Light We Planted**, inspector visible, Details Bar hidden, no user uploads. The final startup behavior was later changed to a blank **Untitled Episode**; the story remains available through Reset Demo.
...
- Functional regression at capture time: pass with all 15 Chromium stories. Later release validation is recorded in README and `ARCHITECTURE.md`.
