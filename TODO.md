...
- [x] Give the Agent a bounded authoritative visual preview, then verify a real correction loop that aligns independent dialogue with balloons embedded in flattened generated art without changing the art.
