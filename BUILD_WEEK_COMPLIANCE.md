...
- [x] The published A/B/C and local corrective running UIs were visually inspected at 1440 × 900, 1280 × 720, and 1024 × 768. Corrective resize handles were additionally exercised at 50%, 100%, and 200% zoom.
...
- [x] Katherine's July 14 A/B/C hands-on review confirmed that placed-element deletion and the bottom **Add asset** action work. Her next manual review failed the proposed polish checkpoint: the title label shifted, candidate guides and a visible magnet were absent, full-width Background-region live drag disagreed with the document/minimap until remount, and selected assets had no corner handles. Those findings are recorded rather than hidden; the corrective implementation now passes local validation and Katherine's retest remains open.
...
| Local corrective checkpoint D | Stable title footprint; provisional `form-observed` profile and default-on editor-only 1,280-unit candidate guides; default-on 8 CSS-pixel center magnet with temporary guide and magnet-off/Alt bypass; live and structural Background-region `x = 0`; four proportional corner handles for selected unlocked ordinary elements with 24-unit minimum, Text scaling, and no rotate/flip/Background-region resize; format remains v3 | Implemented and validated locally; Katherine review pending; not pushed |
| Corrective checkpoint validation | 120 unit tests, strict typecheck, ESLint, production build, one isolated expanded Playwright Chromium walkthrough covering title anchors, guides, magnet bypass/snap, live Background constraint/remount, resize/minimap agreement, and visual inspection at 1440 × 900, 1280 × 720, and 1024 × 768 | Complete locally July 14 |
| Corrective checkpoint screenshot | `docs/progress/2026-07-14-stable-editing-guides-and-resize.png`, 1440 × 900, 132,504 bytes, SHA-256 `798992900f6a899378d07155a5eeb5f5eadc204e6661d3262ac0435b180489cc`; selected code-defined Amber shape with four handles near the dotted 1,280 candidate, visible magnet/guide controls, and no private art | Complete local evidence; not yet published |
