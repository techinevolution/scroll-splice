...
| Optional local Agent companion | Official `codex-cli 0.144.5` App Server in isolated local state; localhost/capability/origin protections; disconnected/static fallback; GPT-5.5/GPT-5.6 model filtering; persistent overlay; bounded revision/context-checked editor tools; generated-image staging/import/place/undo | Disconnected and synthetic protocol paths validated July 20 with 411 Vitest cases across 34 files, 11 companion checks, typecheck, lint, production build, and all 19 Playwright Chromium stories; Katherine then completed the official connection, received a live reply, and confirmed native synthetic generation and placement |
