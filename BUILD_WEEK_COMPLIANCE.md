...
| Post-review A/B/C checkpoints | Click-title activation without a pencil, synchronized base-color controls, placed-element deletion, code-defined synthetic demo placement, safe coarse/fine episode-height control, solid movable Background color regions, and transient Fit Width-relative 50–200% two-dimensional viewport/minimap | Complete locally July 13 in `6a2b58a` through `479a2b6`; remote publication separately gated |
...
| Creator controls, height, and zoom progress screenshot | `docs/progress/2026-07-13-creator-controls-height-and-zoom.png`, 1440 × 900, 108,387 bytes, SHA-256 `b6dcfc9bd7046a955ba06e19027b14bfae67b29f8bc58e277fe77b293301fe29`; public-safe code-defined fixture only | Complete locally; remote publication separately gated |
