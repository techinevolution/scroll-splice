...
- [x] The July 15 review correction proves application-menu hit testing above the open Asset Library, compact **Decor** label containment, and active-category toggle-close in Chromium; its public-safe screenshot contains no uploaded user art. Publication remains to be recorded after the passing commit reaches `main`.
...
| Menu and Asset Library polish screenshot | `docs/progress/2026-07-15-menu-and-asset-rail-polish.png`, 1440 × 900 PNG, SHA-256 `aa160a27ef595f06b8f93261c595851b7f8fca0a70a3224b114d478ba7e1d3d7`; File menu above the open Decor drawer, compact label, original Radiance accent, and synthetic fixture only | Complete local evidence; publication pending final checks |
