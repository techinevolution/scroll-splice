...
| Historical fixed-width corrective checkpoint D | Stable title footprint, provisional candidate guides, center magnet/bypass, structural Background-region `x = 0`, and four proportional ordinary-element handles | Implemented and validated locally, then superseded for Background-region behavior; not pushed |
...
| Local history/save/menu slice | 100-checkpoint document history; create/delete/move/resize/title/height/layer-change undo; one explicit versioned browser save; reload auto-open; confirmed Reopen and New Episode; exact File/Edit menus and shortcuts | 154 unit tests, strict typecheck, ESLint, production build, two isolated Playwright Chromium tests, supported-size visual inspection, and Katherine's July 15 hands-on review pass; publication authorized with the next passing stack |
| Local save/history screenshot | `docs/progress/2026-07-14-local-save-and-history.png`, 1440 × 900 PNG, 126,756 bytes, SHA-256 `53a443469634c0b24c510bfc35cb7a2b14809d444fa678bb5a8ff16f69e49125`; File menu, code-defined fixture with selected handles, Layers/minimap, and **Saved locally** status; no private art | Complete local visual evidence; does not by itself prove reload/reopen; not pushed |
| Persistent Asset Library slice | Fixed Uploads/Speech Balloons/Decorations/Splatters/My Library rail; nine original transparent built-ins; creator categories; validated PNG/JPEG/WebP sources in IndexedDB; predecode header dimension and 40-megapixel enforcement; atomic concurrent-tab read/merge/write updates with current-tab refresh; format-v4 image elements; supported v3-to-v4 opening; source reuse; clear extreme-ratio refusal; missing-source fallback; normal image placement/history/resize/minimap/Layers behavior | 214 unit tests across 11 files, strict typecheck, ESLint, production build, four Playwright Chromium stories including pixel-level alpha compositing and uploaded-image resize through undo/redo/save/reload/reopen, responsive overlay checks at 1440 × 900, 1280 × 720, and 1024 × 768, plus public-safe visual inspection pass locally; push authorized after final repository checks |
| Asset Library screenshot | `docs/progress/2026-07-15-persistent-asset-library.png`, 1440 × 900 PNG, 174,153 bytes, SHA-256 `c350fbc0bfb0d9a14507dc5fe5940584aaa38d3210dcf5bd0efc594647b46fbc`; fixed rail, original starter balloons, placed image with four handles, Layers, and minimap; no private art | Complete local visual evidence; does not by itself prove import or persistence |
