...
- [x] An isolated Playwright Chromium context can complete the expanded defining story, including click-title commit/cancel/validation, numbered-plane navigation, safe empty-plane deletion, synchronized Layers/canvas base-color changes, code-defined synthetic placement in empty and populated ordinary planes, placed-element deletion, coarse and safe precise height changes, solid Background color-region creation and movement, Fit Width-relative 50–200% two-axis navigation, element movement at 200% zoom, minimap agreement, and reset. The paperclip path is accurately limited to synthetic demo rectangles and is not claimed as real image import.
...
- [x] Katherine's July 14 hands-on review confirmed that placed-element deletion and the bottom **Add asset** action work in the complete A/B/C build. The same review found a nonblocking title-label shift and Background-region drag jitter; both are documented in the next bounded goal rather than hidden from the project record.
- [x] The defining human editor story works with every optional OpenAI feature disabled or unavailable.

The planned WEBTOON candidate-boundary overlay is an editor aid, not current export evidence. Future local slicing and preflight can reduce known reasons for platform intervention, but ScrollSplice must never claim that a profile-passing file is guaranteed to avoid WEBTOON recompression, resizing, reformatting, or other optimization.
...
| Episode Setup and Expandable Scroll checkpoint | Editable 60-character title, safe empty-plane deletion, centralized 1280-unit extension, minimap refitting, reset coverage, and disabled future **Attach asset** placeholder | Complete locally July 13; July 14 publication authorized |
...
| Post-review A/B/C checkpoints | Click-title activation without a pencil, synchronized base-color controls, placed-element deletion, code-defined synthetic demo placement, safe coarse/fine episode-height control, solid movable Background color regions, and transient Fit Width-relative 50–200% two-dimensional viewport/minimap | Complete locally July 13 in `6a2b58a` through `479a2b6`; July 14 publication authorized |
...
| Episode Setup progress screenshot | `docs/progress/2026-07-13-episode-setup-and-expandable-scroll.png`, 1440 × 900, SHA-256 `007a46bf91815d4f78546d9a8561c6bb456ca4f8b3c7b12389ca3ec9e621bec3` | Complete locally; July 14 publication authorized |
| Post-review expandable-scroll baseline | `docs/progress/2026-07-13-post-review-expandable-scroll.png`, 1440 × 900, 103,161 bytes, SHA-256 `3513a6bcaec50ceb3ddeeb60bdbafa4fdd57db9fa503cce1b27c2345fc011820`; captured before A/B/C implementation and does not imply those features exist | Complete locally; July 14 publication authorized |
| Creator controls, height, and zoom progress screenshot | `docs/progress/2026-07-13-creator-controls-height-and-zoom.png`, 1440 × 900, 108,387 bytes, SHA-256 `b6dcfc9bd7046a955ba06e19027b14bfae67b29f8bc58e277fe77b293301fe29`; public-safe code-defined fixture only | Complete locally; July 14 publication authorized |
...
| July 14 follow-up findings | Title activation shifts the fixed **EPISODE** label; full-width Background-region horizontal drag feels janky; profile-derived candidate guides and later deterministic self-slicing are documented | Recorded for the next bounded goal and later export checkpoint |
